...
# ──────────────────────────────────────────────────────────────────────────────
# RTSP live-stream processor
# ──────────────────────────────────────────────────────────────────────────────

class RTSPVideoProcessor:
    def __init__(self, rtsp_url: str, detector: PersonDetector, classifier: ActivityClassifier):
        self.rtsp_url   = rtsp_url
        self.detector   = detector      # shared — already loaded at app startup
        self.classifier = classifier    # shared — already loaded at app startup
